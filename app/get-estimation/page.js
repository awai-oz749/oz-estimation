...
export const metadata = {
  ...
  alternates: { canonical: 'https://brixestimation.com/get-estimation/' },
  openGraph: {
    title: 'Get Free Construction Estimation | Brix Estimation',
    description: 'Upload plans, get a free detailed cost estimation in 24-48 hours. No obligation. 98% accuracy.',
    url: 'https://brixestimation.com/get-estimation/',
  ...
  twitter: {
    ...
    site: '@brixestimation',
    title: 'Free Estimation | Brix Estimation',
...
const estimationJsonLd = [
  {
    ...
    mainEntity: {
      ...
      provider: { '@id': 'https://brixestimation.com/#organization' },
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Get Free Estimation', item: 'https://brixestimation.com/get-estimation' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    tool: [{ '@type': 'HowToTool', name: 'Brix Estimation online quote form' }],
    step: [
      {
        '@type': 'HowToStep',
        position: 1,
        ...
        url: 'https://brixestimation.com/get-estimation/#step-1',
      },
      {
        '@type': 'HowToStep',
        position: 2,
        ...
        url: 'https://brixestimation.com/get-estimation/#step-2',
      },
      {
        '@type': 'HowToStep',
        position: 3,
        ...
        url: 'https://brixestimation.com/get-estimation/#step-3',
      },
    ],
  },
];
