...
export const metadata = {
  ...
  alternates: { canonical: 'https://brixestimation.com/services/' },
  openGraph: {
    title: 'Estimation Services — All Trades | Brix Estimation',
    description: '8 categories, 34+ specialized services. MEP, structural, envelope, finishes & more. ASPE-certified.',
    url: 'https://brixestimation.com/services/',
  ...
  twitter: {
    ...
    site: '@brixestimation',
    title: 'Estimation Services | Brix Estimation',
...
const servicesJsonLd = [
  {
    ...
    url: 'https://brixestimation.com/services',
    inLanguage: 'en-US',
    mainEntity: { '@id': 'https://brixestimation.com/#servicelist' },
