...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: { canonical: `https://brixestimation.com/services/${category}/` },
    openGraph: {
      title: `${cat.title} Services | Brix Estimation`,
      description: `${cat.services.length} specialized ${cat.title.toLowerCase()} services. ASPE-certified. 24-48 hours.`,
      url: `https://brixestimation.com/services/${category}/`,
    ...
    twitter: {
      ...
      site: '@brixestimation',
      title: `${cat.title} | Brix Estimation`,
    ...
    hasOfferCatalog: {
      ...
      itemListElement: cat.services.map((s, i) => ({
        ...
        itemOffered: {
          '@type': 'Service',
          name: s.title,
          url: `https://brixestimation.com/services/${category}/${s.slug}`,
        },
      })),
    },
  };
